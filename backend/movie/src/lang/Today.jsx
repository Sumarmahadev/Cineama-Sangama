    ...
    <section className="px-6 py-8">
      ...
      <div className="flex items-center justify-between mb-5">
        <div className="flex items-center gap-3">
          <span className="bg-red-900/40 text-red-300 text-[9px] font-semibold uppercase tracking-widest px-2.5 py-1 rounded border border-red-700/25">
            New
          </span>
      ...
      {data.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center gap-3 border border-dashed border-white/10 rounded-2xl py-14 text-white/25">
          ...
          <p className="text-sm">No selections for today yet</p>
        </div>
      )}
