    ...
    <section className="px-6 py-8">
      ...
      <div className="flex items-center justify-between mb-5">
        <div className="flex items-center gap-3">
          <span className="bg-emerald-900/40 text-emerald-300 text-[9px] font-semibold uppercase tracking-widest px-2.5 py-1 rounded border border-emerald-700/25">
            EN
          </span>
      ...
      {data.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center gap-3 border border-dashed border-white/10 rounded-2xl py-14 text-white/25">
          ...
          <p className="text-sm">No English movies available yet</p>
        </div>
      )}
